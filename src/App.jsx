...
const items = [
  ...
  {
    img: `${import.meta.env.BASE_URL}pexels-energepic-com-27411-159886.jpg`,
    name: "Sama",
    price: 3000,
  ...
  {
    img: `${import.meta.env.BASE_URL}pexels-hasanalbari-1229861.jpg`,
    name: "Sama",
    price: 1000,
  ...
  {
    img: `${import.meta.env.BASE_URL}pexels-morningtrain-18105.jpg`,
    name: "Sama",
    price: 7000,
  ...
  {
    img: `${import.meta.env.BASE_URL}pexels-picjumbo-com-55570-196655.jpg`,
    name: "Sama",
    price: 10000,
  ...
  {
    img: `${import.meta.env.BASE_URL}pexels-pixabay-459653.jpg`,
    name: "Sama",
    price: 3600,
